          ...
          >
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <button
                  onClick={logout}
                  className="w-full p-4 bg-red-50 border border-red-200 rounded-lg text-red-700 hover:bg-red-100 transition-colors font-medium flex items-center justify-center"
                >
